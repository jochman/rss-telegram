...
INCLUDE_DESCRIPTION = (
    os.environ.get("INCLUDE_DESCRIPTION", "false").lower() == "true"
)  # Default: false
DISABLE_NOTIFICATION = (
    os.environ.get("DISABLE_NOTIFICATION", "false").lower() == "true"
)  # Default: false
...
async def send_grouped_messages(bot: Bot, messages_by_feed):
...
async def main_async():
    ...
    logger.info(
        f"Configuration: INCLUDE_DESCRIPTION={INCLUDE_DESCRIPTION}, DISABLE_NOTIFICATION={DISABLE_NOTIFICATION}"
    )
